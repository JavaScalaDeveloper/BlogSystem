    ...
    <el-menu class="navbar" mode="horizontal">
      ...
      <div class="right-menu">
        ...
        <el-tooltip content="Gitee源码" effect="dark" placement="bottom">
          <blogGit id="git" class="right-menu-item" />
        </el-tooltip>

        <el-tooltip content="文档地址" effect="dark" placement="bottom">
          <blogDoc id="doc" class="right-menu-item" />
        </el-tooltip>
      ...
      <el-row class="panel-group" style="margin-left:20px;" :gutter="40">
        <el-collapse v-model="activeName" accordion>
          ...
          <el-collapse-item title="2018.12.19 更新" name="2">
            ...
            <div>项目地址：https://gitee.com/159753/blog_v2</div>
          </el-collapse-item>
          <el-collapse-item title="2018.12.18 更新" name="3">
            <div>重新部署了线上环境</div>
            <div>线上环境地址：http://www.blogit.cn</div>
          </el-collapse-item>
        </el-collapse>
      </el-row>
    </el-dialog>
...
import blogGit from '@/components/blog/Git'
import blogDoc from '@/components/blog/Doc'
import Website from '@/components/blog/Website'
