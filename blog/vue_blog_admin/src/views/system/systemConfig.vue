  ...
  <div class="app-container">
    <el-tabs type="border-card" @tab-click="handleClick" v-model="activeName">
      ...
      <el-tab-pane name="four"  v-permission="'/systemConfig/getSystemConfig'">
        ...
        >
          <aside>
            使用 <a href="http://www.blogit.cn/#/info?blogUid=735ed389c4ad1efd321fed9ac58e646b">七牛云</a> 构建对象存储服务<br/>
          </aside>
      ...
      <el-tab-pane name="five" v-permission="'/systemConfig/getSystemConfig'">
        ...
        >
          ...
          <aside>
            使用 <a href="http://www.blogit.cn/#/info?blogUid=a1058b2d030310e2c5d7b0584e514f1f">Minio</a> 构建本地对象存储服务<br/>
          </aside>
