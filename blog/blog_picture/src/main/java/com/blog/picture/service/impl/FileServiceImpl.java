package com.mogu.blog.picture.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.mogu.blog.commons.entity.File;
import com.mogu.blog.commons.entity.FileSort;
import com.mogu.blog.commons.entity.SystemConfig;
import com.mogu.blog.picture.global.MessageConf;
import com.mogu.blog.picture.global.SQLConf;
import com.mogu.blog.picture.global.SysConf;
import com.mogu.blog.picture.mapper.FileMapper;
import com.mogu.blog.picture.service.*;
import com.mogu.blog.picture.util.AboutFileUtil;
import com.mogu.blog.picture.util.FeignUtil;
import com.mogu.blog.utils.FileUtils;
import com.mogu.blog.utils.JsonUtils;
import com.mogu.blog.utils.ResultUtil;
import com.mogu.blog.utils.StringUtils;
import com.blog.base.enums.EFilePriority;
import com.blog.base.enums.EOpenStatus;
import com.blog.base.enums.EStatus;
import com.blog.base.exception.exceptionType.InsertException;
import com.blog.base.global.Constants;
import com.blog.base.global.ErrorCode;
...
public class FileServiceImpl extends SuperServiceImpl<FileMapper, File> implements FileService {
    ...
    public String getPicture(String fileIds, String code) {
        ...
        if (StringUtils.isEmpty(fileIds)) {
            ...
            QueryWrapper<com.mogu.blog.commons.entity.File> queryWrapper = new QueryWrapper<>();
            queryWrapper.in(SQLConf.UID, changeStringToString);
            List<com.mogu.blog.commons.entity.File> fileList = fileService.list(queryWrapper);
            if (fileList.size() > 0) {
                for (com.mogu.blog.commons.entity.File file : fileList) {
                    if (file != null) {
    ...
    public String uploadPictureByUrl(FileVO fileVO) {
        ...
        List<com.mogu.blog.commons.entity.File> lists = new ArrayList<>();
        //文件上传
        if (urlList != null && urlList.size() > 0) {
            for (String itemUrl : urlList) {
                ...
                com.mogu.blog.commons.entity.File file = new com.mogu.blog.commons.entity.File();
                file.setCreateTime(new Date(System.currentTimeMillis()));
                file.setFileSortUid(fileSort.getUid());
