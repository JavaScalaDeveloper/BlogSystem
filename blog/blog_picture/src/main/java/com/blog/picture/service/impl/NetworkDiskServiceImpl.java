...
import com.mogu.blog.commons.entity.NetworkDisk;
import com.mogu.blog.commons.entity.Storage;
import com.mogu.blog.picture.global.SQLConf;
import com.mogu.blog.picture.global.SysConf;
import com.mogu.blog.picture.mapper.NetworkDiskMapper;
import com.mogu.blog.picture.service.NetworkDiskService;
import com.mogu.blog.picture.service.StorageService;
import com.mogu.blog.picture.util.FeignUtil;
import com.mogu.blog.picture.util.MinioUtil;
import com.mogu.blog.picture.util.blogFileUtil;
import com.mogu.blog.picture.util.QiniuUtil;
import com.mogu.blog.picture.vo.NetworkDiskVO;
import com.mogu.blog.utils.StringUtils;
import com.mogu.blog.utils.upload.FileUtil;
import com.blog.base.enums.EFilePriority;
import com.blog.base.enums.EOpenStatus;
import com.blog.base.enums.EStatus;
import com.blog.base.exception.exceptionType.UpdateException;
    ...
    public void deleteFile(NetworkDiskVO networkDiskVO, Map<String, String> qiNiuConfig) {
        ...
        if (SysConf.ONE == networkDisk.getIsDir()) {
            ...
            if (list.size() > 0) {
                ...
                if (isUpdateSuccess) {
                    ...
                    if (EOpenStatus.OPEN.equals(uploadLocal)) {
                        ...
                        // 批量删除本地图片
                        blogFileUtil.deleteFileList(fileList);
                    }
                    // 删除七牛云上文件
            ...
            if (EOpenStatus.OPEN.equals(uploadLocal)) {
                ...
                blogFileUtil.deleteFile(UPLOAD_PATH + localUrl);
            }
            // 删除七牛云上文件
            if (EOpenStatus.OPEN.equals(uploadQiNiu)) {
