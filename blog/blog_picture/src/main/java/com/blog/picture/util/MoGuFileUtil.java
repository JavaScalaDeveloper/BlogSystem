...
public class blogFileUtil {
    ...
    public static boolean deleteDirectory(String dir) {
        ...
        for (int i = 0; i < files.length; i++) {
            // 删除子文件
            if (files[i].isFile()) {
                flag = blogFileUtil.deleteFile(files[i].getAbsolutePath());
                if (!flag) {
                    break;
                }
            }
            // 删除子目录
                ...
                flag = blogFileUtil.deleteDirectory(files[i]
                        .getAbsolutePath());
                if (!flag) {
                    break;
                }
    ...
    public static void main(String[] args) {
        // 删除单个文件
        String file = "D:\\blog\\data\\blog\\admin\\webp\\2020\\6\\15\\123.txt";
        blogFileUtil.deleteFile(file);
        System.out.println();

        // 删除一个目录
//        String dir = "D:/home/web/upload/upload/files";
//        blogFileUtil.deleteDirectory(dir);
