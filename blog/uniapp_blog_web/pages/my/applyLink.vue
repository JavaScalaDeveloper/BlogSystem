<template name="basics">
	<view>
		...
		<view>
			...
			<view class="action" style="margin-top: 10px;">
				<text class="cuIcon-emoji text-red" style="font-size: 18px; margin-left: 15px; margin-right: 5px;"></text> 申请前请先添加下方博客友链
			</view>
			<view class="action" style="margin-top: 10px;" >
		...
		<view class="box">
			<view class="cu-bar">
				<view class="action border-title">
					<text class="text-xl text-bold text-blue">博客</text>
					<text class="bg-gradual-blue" style="width:3rem"></text>
				</view>
			</view>
		</view>
		...
		<view>
			<view class="action" style="margin-top: 10px;">
				<text class="cuIcon-edit text-red" style="font-size: 18px; margin-left: 15px; margin-right: 5px;"></text> 博客
			</view>
			<view class="action" style="margin-top: 10px;">
				<text class="cuIcon-pic text-red" style="font-size: 18px; margin-left: 15px; margin-right: 5px;"></text> http://image.blogit.cn/favicon.png
			</view>
			<view class="action" style="margin-top: 10px;">
				<text class="cuIcon-calendar text-red" style="font-size: 18px; margin-left: 15px; margin-right: 5px;"></text> 博客 - 专注于技术分享的博客平台
			</view>
			<view class="action" style="margin-top: 10px;" >
				<text class="cuIcon-weblock text-red" style="font-size: 18px; margin-left: 15px; margin-right: 5px;"></text> http://www.blogit.cn
			</view>
		</view>
