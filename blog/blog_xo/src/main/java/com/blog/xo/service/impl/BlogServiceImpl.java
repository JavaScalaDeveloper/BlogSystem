...
import com.mogu.blog.commons.entity.*;
...
import com.mogu.blog.xo.mapper.BlogMapper;
import com.mogu.blog.xo.mapper.BlogSortMapper;
import com.mogu.blog.xo.mapper.TagMapper;
import com.mogu.blog.xo.service.*;
import com.mogu.blog.xo.utils.WebUtil;
import com.mogu.blog.xo.vo.BlogVO;
import com.blog.base.enums.*;
import com.blog.base.global.BaseSQLConf;
import com.blog.base.global.BaseSysConf;
...
public class BlogServiceImpl extends SuperServiceImpl<BlogMapper, Blog> implements BlogService {
    ...
    public String editBatch(List<BlogVO> blogVOList) {
        ...
        if (save) {
            ...
            //发送到RabbitMq
            rabbitTemplate.convertAndSend(SysConf.EXCHANGE_DIRECT, SysConf.BLOG, map);
        }
