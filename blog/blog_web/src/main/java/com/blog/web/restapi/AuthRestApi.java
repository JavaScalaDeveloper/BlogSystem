package com.mogu.blog.web.restapi;
...
import com.mogu.blog.commons.entity.Link;
import com.mogu.blog.commons.entity.SystemConfig;
import com.mogu.blog.commons.entity.User;
import com.mogu.blog.commons.feign.PictureFeignClient;
import com.mogu.blog.utils.*;
import com.mogu.blog.web.global.MessageConf;
import com.mogu.blog.web.global.RedisConf;
import com.mogu.blog.web.global.SQLConf;
import com.mogu.blog.web.global.SysConf;
import com.mogu.blog.xo.service.*;
import com.mogu.blog.xo.utils.RabbitMqUtil;
import com.mogu.blog.xo.utils.WebUtil;
import com.mogu.blog.xo.vo.FeedbackVO;
import com.mogu.blog.xo.vo.LinkVO;
import com.mogu.blog.xo.vo.UserVO;
import com.blog.base.enums.EGender;
import com.blog.base.enums.ELinkStatus;
...
public class AuthRestApi {
    ...
    public String updateUserPwd(HttpServletRequest request, @RequestParam(value = "oldPwd") String oldPwd, @RequestParam("newPwd") String newPwd) {
        ...
        User user = userService.getById(userUid);
        // 判断是否是第三方登录的账号
        if (!user.getSource().equals(SysConf.blog)) {
        ...
        switch (source) {
            case SysConf.GITHUB:
                authRequest = new AuthGithubRequest(AuthConfig.builder()
                        ...
                        .redirectUri(blogWebUrl + "/oauth/callback/github")
                        .build());
                break;
            case SysConf.GITEE:
                authRequest = new AuthGiteeRequest(AuthConfig.builder()
                        ...
                        .redirectUri(blogWebUrl + "/oauth/callback/gitee")
                        .build());
                break;
            case SysConf.QQ:
                authRequest = new AuthQqRequest(AuthConfig.builder()
                        ...
                        .redirectUri(blogWebUrl + "/oauth/callback/qq")
                        .build());
                break;
            default:
                break;
